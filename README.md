...
<div style="background-color: #ffc4c4; border-style: solid; padding: 5px;">
   <p> <strong>Note</strong>: I have been using Adjutant of analyze an <a href="https://pages.semanticscholar.org/coronavirus-research"> open dataset of COVID-19 papers</a>. I've made this analysis available online in a different repository: <a href="https://github.com/amcrisan/covid-19-papers"> https://github.com/amcrisan/covid-19-papers</a>. Please feel free to contact me if you'd like additional information on this analysis.  </p>
</div>
